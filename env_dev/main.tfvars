...
apps = {
  ...
  catalogue = {
    ...
    extra_param_access  = ["arn:aws:ssm:us-east-1:155405255921:parameter/roboshop.dev.docdb.*"]
  }
  user = {
    component           = "user"
    app_port            = 8080
  ...
  shipping = {
    ...
    extra_param_access  = ["arn:aws:ssm:us-east-1:155405255921:parameter/roboshop.dev.mysql.*"]
  }
  payment = {
    component           = "payment"
    app_port            = 8080
